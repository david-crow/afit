...
using RadarCallback_onObjectIlluminatedByRadar = std::function< void( const WO* ) >;
...
public:
   ...
   */
   ...
   void addPossibleTargetToRadarScanList( WO* objToSearchFor, const RadarCallback_onObjectIlluminatedByRadar& onRadarIlluminationOccurredCallback );
