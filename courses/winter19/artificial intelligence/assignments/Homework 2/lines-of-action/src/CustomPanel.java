...
public class CustomPanel extends JPanel {
	...
	public void loadImages() {
		try {
			background = ImageIO.read(new File("img/LOA-Grid.png"));
			black_piece = ImageIO.read(new File("img/LOA-Black.png"));
			white_piece = ImageIO.read(new File("img/LOA-White.png"));
