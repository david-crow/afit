...
public class RushHour
{
    ...
    public static void main(String[] args) throws IOException {
      ...
      char x[] = new char[2]; // temp variable used for file parsingq
      ...
      while (numBoards > 0) {
        ...
        System.out.println( "Board: " + boardCounter + "  " + ( (float)(System.currentTimeMillis() - startTime) / 1000.0) + " seconds" );
        System.out.println("Nodes Visited: " + search.nodeCount());

        // Before printing, we need to reverse the move list
        if ( result == null )
